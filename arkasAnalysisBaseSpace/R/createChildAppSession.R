...
message(paste0("copying samples from ",fullPath," to ",scratchDestination," ..."))
...
message("done copying to scratch ... ")

appSession$fastaPath<-fastaPath
appSession$bootstraps<-bootstrapValue
appSession$outputPath<-paste0(outputPath,"/Results")#appresults/project_id/results/
...
#
message("finding the raw file extension illumina standard naming convention...")
